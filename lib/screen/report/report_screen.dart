...
import '../../model/model/supplier.dart';
...
class ReportScreenState extends State<ReportScreen> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MainViewModel>.reactive(viewModelBuilder: () {
      ...
      viewModel.getDailyReports(selectedDay);
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            Padding(
              ...
              child: IconButton(
                icon: Image.asset(Assets.imagesPdf, width: 24, height: 24,),
                onPressed: (){
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold, color: isMonth ? Colors.white : Colors.black, fontSize: 14),
                                  ),
                                ),
                              ),
                            ),
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    ...
    page.graphics.drawString(
        'Hisobot', PdfStandardFont(PdfFontFamily.helvetica, 30),
