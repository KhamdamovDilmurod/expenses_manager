...
class KirimQoshishScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return KirimQoshishScreenState();
  }
}

class KirimQoshishScreenState extends State<KirimQoshishScreen> {
  ...
  final List<String> typesOfExpenses = ['Qozonga', 'Tillo investga', 'Bir narsaga'];
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField2<String>(
                        ...
                        validator: (value) {
                          if (value == null) {
                            return 'Iltimos kirim turini belgilang.';
                          }
                          return null;
                        },
                        onChanged: (value) {
